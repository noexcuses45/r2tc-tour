...
export default function UpcomingRoundsScreen({ onBack, isAdmin, onOpenSettings }: { onBack: () => void; isAdmin?: boolean; onOpenSettings?: (ev: any) => void }) {
